 ...
 *	searches through linked lists for an anchor that matches the
 *	function name.  Once found, the symbol member is returned.
 *
 *	The Anchor lists superceed any symbols from already loaded 
